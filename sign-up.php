  ...
  <div class="panel">
    <div class="panel-body">
      ...
      <span class="alert alert-danger-error" id="loginFailMsg" style="display: none">Something may have gone wrong</span> <!-- Added by LS -->
	          ...
	          <span class="alert alert-error" id="inputNameMsg" style="display: none">Something may have gone wrong</span> <!-- Added by LS -->
                </div>
              </div> <!-- / .form-group -->
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
                  ...
                  <p class="help-block" id="inputPasswordMsg">Please use a secure password.</p>
                </div>
              </div> <!-- / .form-group -->
              <div class="form-group">
              ...
              <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                  <div class="checkbox">
                    <label>
                      <input type="checkbox" class="px"> <span class="lbl">I agree to the <a href="#">Terms and Conditions</a></span>
                    </label>
                  </div> <!-- / .checkbox -->
                </div>
              </div> <!-- / .form-group -->
              <div class="form-group" style="margin-bottom: 0;">
                <div class="col-sm-offset-2 col-sm-10">
                  <button type="button" class="btn btn-primary" id="signUpSubmit" >Create an Account</button>
                </div>
              </div> <!-- / .form-group -->
            </div>
          <!-- </form> -->
